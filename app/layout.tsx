...
export const metadata: Metadata = {
  title: "Dog Walking & Fresh Breath Training | Mahogany Walks Calgary",
  description: "Professional dog walking in Calgary. Daily walks, playtime, and teeth brushing training your vet will love. First Walk Free!",
};
